...
const translations = {
  en: {
    ...
    'services.svc1Desc': 'Court rulings, notarial acts, contracts, criminal records. Officially certified and legalized translations.',
    'services.svc2Title': 'Civil Status<br/><em>Documents</em>',
    'services.svc2Desc': 'Birth certificates, marriages, divorces, passports, residency permits. For all consular procedures.',
    ...
    'services.svc4Desc': 'Business contracts, tenders, financial reports, professional correspondence.',
  ...
  ar: {
    ...
    'hero.eyebrow': 'مترجمة محلفة · طنجة، المغرب',
    'hero.titleLine1': 'وثائقكم',
    'hero.titleLine2': 'مترجمة بـ',
    'hero.titleLine3': 'دقة عالية.',
    'hero.sub': 'الأستاذة فتحية الوطاسي — مترجمة محلفة معتمدة لدى المحاكم، خريجة مدرسة الملك فهد العليا للترجمة. متخصصة في الترجمات القانونية، الرسمية والمعتمدة للأفراد والشركات.',
    'hero.btnCall': 'الاتصال بالمكتب',
    'hero.btnEmail': 'إرسال بريد إلكتروني',
    'heroCard.name': 'الأستاذة فتحية<br/>الوطاسي',
    'heroCard.role': 'مترجمة محلفة<br/><em>Sworn Translator</em>',
    ...
    'marquee.m5': 'مترجمة محلفة',
    'marquee.m6': 'هجرة',
    'marquee.m7': 'عقود',
    'marquee.m8': 'شهادات',
    'services.label': 'خبراتنا',
    'services.h2': 'ما نقوم<br/><em>بتجمته</em>',
    'services.svc1Title': 'ترجمة قانونية<br/><em>ومحلفة</em>',
    'services.svc1Desc': 'الأحكام، العقود التوثيقية، العقود، السجلات العدلية. ترجمات معتمدة ومصادق عليها رسمياً.',
    'services.svc2Title': 'وثائق<br/><em>الحالة المدنية</em>',
    'services.svc2Desc': 'عقود الازدياد، الزواج، الطلاق، جوازات السفر، بطاقات الإقامة. لجميع المعاملات القنصلية.',
    ...
    'services.svc4Desc': 'عقود الأعمال، طلبات العروض، التقارير المالية، المراسلات المهنية.',
    ...
    'about.p1': 'خريجة مدرسة الملك فهد العليا للترجمة بـ طنجة، تمارس الأستاذة فتحية الوطاسي مهنة مترجمة محلفة معتمدة لدى المحاكم المغربية منذ عدة سنوات.',
    ...
    'footer.brandSub': 'الأستاذة فتحية الوطاسي · مترجمة محلفة',
  ...
  fr: {
    ...
    'services.svc1Desc': 'Jugements, actes notariés, contrats, casiers judiciaires. Traductions officiellement certifiées et légalisées.',
    'services.svc2Title': 'Documents<br/><em>d\'État Civil</em>',
    'services.svc2Desc': 'Actes de naissance, mariages, divorces, passeports, titres de séjour. Pour toutes démarches consulaires.',
    ...
    'services.svc4Desc': 'Contrats d\'affaires, appels d\'offres, rapports financiers, correspondances professionnelles.',
